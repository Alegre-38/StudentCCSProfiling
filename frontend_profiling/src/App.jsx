...
import ComprehensiveSearch from './pages/ComprehensiveSearch';
...
// SVG Icons
const IconMenu = () => (
  <svg style={{width:'22px',height:'22px',stroke:'currentColor',strokeWidth:'2',strokeLinecap:'round',strokeLinejoin:'round',fill:'none'}} viewBox="0 0 24 24">
      ...
      <header className="top-header">
        ...
        <div style={{marginLeft:'auto', display:'flex', alignItems:'center', gap:'0.6rem'}}>
          ...
          <button onClick={logout} title="Sign out" style={{
            ...
            color:'rgba(238,238,238,0.7)', borderRadius:'8px', padding:'0.4rem 0.7rem',
            cursor:'pointer', display:'flex', alignItems:'center', gap:'0.4rem',
            fontSize:'0.82em', fontWeight:600, boxShadow:'none', transition:'all 0.2s',
          }}>
            <IconLogout /> Sign out
          </button>
        </div>
